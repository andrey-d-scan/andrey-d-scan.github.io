document.addEventListener('DOMContentLoaded', function() {
    ...
    client.init('d9b33ffa68a342d48ea2204de2d723ed', {
        transparent: 1,
                ...
                api.getMaterialList(function(err, materials) {
                    if (!err) {
                        ...
                        function changeColor(materialName, color) {
                            var material = myMaterials.find(m => m.name === materialName);
                            if (material) {
                                ...
                                api.setMaterial(material, function(err, result) {
                                    if (err) {
                                        ...
                                        console.log('Цвет материала ' + materialName + ' изменен');
                                    }
                                });
                            } else {
                        ...
                        function changeOpacity(materialName, opacityValue) {
                            ...
                            if (material) {
                                material.channels.Opacity = {
                                    enable: true,
                                    factor: opacityValue // Устанавливаем значение прозрачности от 0 до 1
                                };
                                api.setMaterial(material, function(err, result) {
                                    if (err) {
                                        console.error('Ошибка при обновлении материала:', err);
